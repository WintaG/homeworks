...
public class MyStringLinkedList {
	...
	// implement the postAddNode code
	public void postAddNode(Node n, String value) {

		if (header == null) {
			header = n;
			Node newNode = new Node(header, value, null);
			header.next = newNode;
		} else {
			for (Node x = header; x != null; x = x.next) {
				if (x.value.equals(value)) {
					Node temp = x.next;
					Node newNode = new Node(x, value, temp);
	...
	public void print(Node n) {
		System.out.println(findItem(n.value).value);
	}
